        ...
        <div className="grid grid-cols-12 gap-6 items-end">
          <div className="col-span-12 lg:col-span-7">
            <p className="text-xs tracking-[0.3em] uppercase text-muted-foreground mb-6">
              The Catalog — AW25 / Resort 26
            </p>
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-light leading-[0.9]">
              Pieces<br />to live in.
            </h1>
          </div>
          <div className="col-span-12 lg:col-span-4 lg:col-start-9">
            <p className="text-base text-muted-foreground leading-relaxed max-w-md">
              Forty-two pieces, each made by hand in a single European atelier.
              No restocks. When a piece is gone, it is gone.
            </p>
          </div>
        </div>
      </header>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-12 gap-x-6 gap-y-24">
            {filtered.map((p, i) => {
              ...
              const aspect =
                pattern % 2 === 0 ? 'aspect-[3/4]' : 'aspect-[4/5]';
